...
if(SERVER)then
	...
	function VGUI:Init()
		...
		local okButton = MC.CreateButton(FactoryMenu,{x=180,y=35},{x=520,y=285})
...
LDE.Factorys.BuildList.BBomb = {
	...
	matamount={200,80},
	Time=3,
	desc="The N-X23 Basic Chemical Bomb is often used for its cheap and destructive nature."
}
...
LDE.Factorys.BuildList.LBomb = {
	...
	matamount={1000,250},
	Time=6,
	desc="The N-B36 Plasma Bomb is loved for its high power yet its affordable price."
}
...
LDE.Factorys.BuildList.PBomb = {
	...
	Time=10,
	desc = "The E-M35 Photon Torpedo is a new design made to exploit the rare qualitys of Polylodarium when infused with light."
}
...
LDE.Factorys.BuildList.ShockBomb = {
	...
	Time=12,
	desc="The S-K64 ShockWave bomb causes a gravity shockwave, that while weak causes damage over a large amount of area."
}
...
LDE.Factorys.BuildList.SNugs = {
	...
	matamount={1200},
	Time=1,
	desc="Gives 5-Seconds Health Regen."
}
